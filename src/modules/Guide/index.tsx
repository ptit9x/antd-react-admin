    ...
    const driverObj = driver({
      ...
      steps: [
        ...
        },
        {
          ...
          popover: {
            title: 'Switch mode',
            description: 'You can click here to switch your mode,',
            side: 'bottom',
            align: 'start'
          }
        },
    ...
    <div className='guide-page '>
      <div className='innerText'>
        <Typography className='guide-intro'>
          The guide page is useful for some people who entered the project for the first time. You can briefly introduce
          the features of the project. Demo is based on
          <Button
            type='link'
